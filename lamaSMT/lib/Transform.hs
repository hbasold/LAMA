...
-- is used (generated by genDefault). Additionally the cycle of the
-- variable which will be defined, can be specified by succ.
...
-- | Creates a definition for a given variable. 
-- The first argument /x/ is the variable to be defined and the last
